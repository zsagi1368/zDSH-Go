...
const VENDORED_PLUGIN_READMES = [
  ...
  'packages/plugins/dsh-guard/README.zh.md',
  ...
  'packages/plugins/webstack-bridge/README.zh.md',
  'packages/plugins/webstack-bridge/extension/README.md',
  'packages/plugins/webstack-bridge/extension/README.zh.md',
  'packages/plugins/webstack-verticals/README.md',
  'packages/plugins/webstack-verticals/README.zh.md',
