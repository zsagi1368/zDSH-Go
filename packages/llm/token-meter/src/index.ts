...
import { cacheMetricsProjectionDefinition } from './cache-metrics.ts'
...
export class TokenMeter extends Service {
  ...
  constructor(ctx: Context, config: TokenMeterConfig = {}) {
    ...
    ctx.sessionProjections.register(cacheMetricsProjectionDefinition)
